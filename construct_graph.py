...
class ContactMatrix:
    ...
    def __init__(self, bam_file, seq_file, viral_file,  path , min_mapq=30, min_len=1000, min_match=30, min_k=5):
        ...
        logger.info('There are {} prokaryotic contigs'.format(prokaryotic_contig_index))
        logger.info('Write information of viral contigs and prokaryotic contigs')
        ...
        del self.map_viral, self.map_row, self.prokaryotic_contig_index, self.viral_same_host, map_temp
